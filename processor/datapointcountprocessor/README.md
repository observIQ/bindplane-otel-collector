> [!WARNING]
> **This component has moved to [bindplane-otel-contrib](https://github.com/observiq/bindplane-otel-contrib/tree/main/processor/datapointcountprocessor).**
...
| match           | string   | ``                | **DEPRECATED** use `ottl_match` instead. A boolean [expression](https://github.com/expr-lang/expr/blob/master/docs/language-definition.md) used to match which datapoints to count. By default, all datapoints are counted.                                               |
...
[datapoint context]: https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/v0.147.0/pkg/ottl/contexts/ottldatapoint/README.md
