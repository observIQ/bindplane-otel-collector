...
type Config struct {
	...
	// When true, the processor will measure the raw bytes of the payload in addition to the protobuf size. This is more expensive but provides raw measurements if designated.
	MeasureRawBytes bool `mapstructure:"measure_raw_bytes"`
}
