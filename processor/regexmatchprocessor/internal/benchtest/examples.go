...
// Package benchtest contains examples regexes and corresponding example logs which match them.
package benchtest
...
// Regexes defines a set of known regexes in order of precedence
var Regexes = []named.Regex{
	{
		Name:  "esxi_syslog",
...
// Examples maps input strings to the expected name of the *first* matching regex in Regexes
