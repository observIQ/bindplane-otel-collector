// Code generated by gen.go from https://schema.ocsf.io/1.7.0/export/schema. DO NOT EDIT.
...
type AccessAnalysisResult struct {
	...
	AccessType             *string                 `mapstructure:"access_type,omitempty"`
	Accessors              []User                  `mapstructure:"accessors"`
	AdditionalRestrictions []AdditionalRestriction `mapstructure:"additional_restrictions,omitempty"`
	ConditionKeys          []KeyValueObject        `mapstructure:"condition_keys,omitempty"`
	GrantedPrivileges      []string                `mapstructure:"granted_privileges,omitempty"`
}

// Validate checks required fields, constraints, and enum values for AccessAnalysisResult.
func (o *AccessAnalysisResult) Validate() error {
	var errs []error
	if len(o.Accessors) == 0 {
		errs = append(errs, errors.New("accessors is required"))
	}
...
// AdditionalRestriction represents the OCSF Additional Restriction object.
...
// Validate checks required fields, constraints, and enum values for AdditionalRestriction.
...
type Email struct {
	...
	FromList         []string     `mapstructure:"from_list,omitempty"`
	FromMailbox      *string      `mapstructure:"from_mailbox,omitempty"`
	FromMailboxes    []string     `mapstructure:"from_mailboxes,omitempty"`
	...
	ReplyToList      []string     `mapstructure:"reply_to_list,omitempty"`
	ReplyToMailboxes []string     `mapstructure:"reply_to_mailboxes,omitempty"`
	ReturnPath       *string      `mapstructure:"return_path,omitempty"`
	Sender           *string      `mapstructure:"sender,omitempty"`
	SenderMailbox    *string      `mapstructure:"sender_mailbox,omitempty"`
	Size             *int64       `mapstructure:"size,omitempty"`
...
type File struct {
	...
	IsEncrypted        *bool              `mapstructure:"is_encrypted,omitempty"`
	IsReadonly         *bool              `mapstructure:"is_readonly,omitempty"`
...
type FindingInfo struct {
	...
	AttackGraph        *Graph           `mapstructure:"attack_graph,omitempty"`
...
// FunctionInvocation represents the OCSF Function Invocation object.
...
type FunctionInvocation struct {
	...
	Parameters  []Parameter `mapstructure:"parameters,omitempty"`
	ReturnValue *string     `mapstructure:"return_value,omitempty"`
}

// Validate checks required fields, constraints, and enum values for FunctionInvocation.
func (o *FunctionInvocation) Validate() error {
	var errs []error
	if o.Error == nil && len(o.Parameters) == 0 && o.ReturnValue == nil {
		errs = append(errs, errors.New("at least one of [error, parameters, return_value] must be set"))
	}
	return errors.Join(errs...)
}
...
// IdentityActivityMetrics represents the OCSF Identity Activity Metrics object.
...
type IdentityActivityMetrics struct {
	FirstSeenTime           *string                  `mapstructure:"first_seen_time,omitempty"`
	LastAuthenticationTime  *string                  `mapstructure:"last_authentication_time,omitempty"`
	LastSeenTime            *string                  `mapstructure:"last_seen_time,omitempty"`
	PasswordLastUsedTime    *string                  `mapstructure:"password_last_used_time,omitempty"`
	ProgrammaticCredentials []ProgrammaticCredential `mapstructure:"programmatic_credentials,omitempty"`
}
...
type Metadata struct {
	...
	LogName                *string              `mapstructure:"log_name,omitempty"`
	LogProvider            *string              `mapstructure:"log_provider,omitempty"`
	LogSource              *string              `mapstructure:"log_source,omitempty"`
	LogVersion             *string              `mapstructure:"log_version,omitempty"`
	LoggedTime             *string              `mapstructure:"logged_time,omitempty"`
	Loggers                []Logger             `mapstructure:"loggers,omitempty"`
	ModifiedTime           *string              `mapstructure:"modified_time,omitempty"`
	OriginalEventUID       *string              `mapstructure:"original_event_uid,omitempty"`
	...
	Reporter               *Reporter            `mapstructure:"reporter,omitempty"`
...
type Module struct {
	...
	File               *File               `mapstructure:"file,omitempty"`
	FunctionInvocation *FunctionInvocation `mapstructure:"function_invocation,omitempty"`
	FunctionName       *string             `mapstructure:"function_name,omitempty"`
	LoadType           *string             `mapstructure:"load_type,omitempty"`
	LoadTypeID         *int                `mapstructure:"load_type_id,omitempty"`
...
type NetworkEndpoint struct {
	...
	MAC              *string           `mapstructure:"mac,omitempty"`
	Name             *string           `mapstructure:"name,omitempty"`
	NetworkScope     *string           `mapstructure:"network_scope,omitempty"`
	NetworkScopeID   *int              `mapstructure:"network_scope_id,omitempty"`
	OS               *OS               `mapstructure:"os,omitempty"`
	Owner            *User             `mapstructure:"owner,omitempty"`
...
type NetworkInterface struct {
	...
	Name         *string    `mapstructure:"name,omitempty"`
	Namespace    *string    `mapstructure:"namespace,omitempty"`
	OpenPorts    []PortInfo `mapstructure:"open_ports,omitempty"`
...
// Parameter represents the OCSF Parameter object.
// The Parameter object provides details regarding a parameter of a a function.
type Parameter struct {
	Name      *string `mapstructure:"name,omitempty"`
	PostValue *string `mapstructure:"post_value,omitempty"`
	PreValue  *string `mapstructure:"pre_value,omitempty"`
}

// Validate checks required fields, constraints, and enum values for Parameter.
func (o *Parameter) Validate() error {
	var errs []error
	if o.Name == nil && o.PostValue == nil && o.PreValue == nil {
		errs = append(errs, errors.New("at least one of [name, post_value, pre_value] must be set"))
	}
	return errors.Join(errs...)
}
...
type PeripheralDevice struct {
	...
	TypeID       *int     `mapstructure:"type_id,omitempty"`
	UID          *string  `mapstructure:"uid,omitempty"`
	VendorIDList []string `mapstructure:"vendor_id_list,omitempty"`
	VendorName   *string  `mapstructure:"vendor_name,omitempty"`
}
...
// PermissionAnalysisResult represents the OCSF Permission Analysis Result object.
...
type PermissionAnalysisResult struct {
	...
	GrantedPrivileges     []string         `mapstructure:"granted_privileges,omitempty"`
	Policy                *Policy          `mapstructure:"policy,omitempty"`
	UnusedPrivilegesCount *int             `mapstructure:"unused_privileges_count,omitempty"`
	UnusedServicesCount   *int             `mapstructure:"unused_services_count,omitempty"`
}
...
func (o *Policy) Validate() error {
	var errs []error
	if o.Name == nil && o.Type == nil && o.UID == nil {
		errs = append(errs, errors.New("at least one of [name, type, uid] must be set"))
	}
	return errors.Join(errs...)
}

// PortInfo represents the OCSF Port Information object.
...
// Validate checks required fields, constraints, and enum values for PortInfo.
...
type Process struct {
	...
	File                 *File                 `mapstructure:"file,omitempty"`
	HostedServices       []WinWinService       `mapstructure:"hosted_services,omitempty"`
	...
	Ptid                 *int64                `mapstructure:"ptid,omitempty"`
...
// ProgrammaticCredential represents the OCSF Programmatic Credential object.
...
type ProgrammaticCredential struct {
	LastUsedTime *string `mapstructure:"last_used_time,omitempty"`
	Type         *string `mapstructure:"type,omitempty"`
	UID          *string `mapstructure:"uid"`
}

// Validate checks required fields, constraints, and enum values for ProgrammaticCredential.
...
// Reporter represents the OCSF Reporter object.
...
// Validate checks required fields, constraints, and enum values for Reporter.
...
type ResourceDetails struct {
	...
	RoleID               *int             `mapstructure:"role_id,omitempty"`
	Tags                 []KeyValueObject `mapstructure:"tags,omitempty"`
	Type                 *string          `mapstructure:"type,omitempty"`
	UID                  *string          `mapstructure:"uid,omitempty"`
	UIDAlt               *string          `mapstructure:"uid_alt,omitempty"`
...
type WinRegValue struct {
	...
	Name              *string  `mapstructure:"name"`
	Path              *string  `mapstructure:"path"`
	RegBinaryData     *string  `mapstructure:"reg_binary_data,omitempty"`
	RegIntegerData    *int64   `mapstructure:"reg_integer_data,omitempty"`
	RegStringData     *string  `mapstructure:"reg_string_data,omitempty"`
	RegStringListData []string `mapstructure:"reg_string_list_data,omitempty"`
	Type              *string  `mapstructure:"type,omitempty"`
	TypeID            *int     `mapstructure:"type_id,omitempty"`
}
...
type WinWinService struct {
	CmdLine               *string          `mapstructure:"cmd_line,omitempty"`
	HostingProcess        *ProcessEntity   `mapstructure:"hosting_process,omitempty"`
	Labels                []string         `mapstructure:"labels,omitempty"`
	...
	ServiceDllFile        *File            `mapstructure:"service_dll_file,omitempty"`
	...
	ServiceFile           *File            `mapstructure:"service_file,omitempty"`
...
type AccountChange struct {
	...
	RawDataHash    *Fingerprint     `mapstructure:"raw_data_hash,omitempty"`
...
type Authentication struct {
	AccountSwitchType   *string              `mapstructure:"account_switch_type,omitempty"`
	AccountSwitchTypeID *int                 `mapstructure:"account_switch_type_id,omitempty"`
	ActivityID          *int                 `mapstructure:"activity_id"`
	ActivityName        *string              `mapstructure:"activity_name,omitempty"`
	Actor               *Actor               `mapstructure:"actor,omitempty"`
	AuthFactors         []AuthFactor         `mapstructure:"auth_factors,omitempty"`
...
type DhcpActivity struct {
	...
	ConnectionInfo     *NetworkConnectionInfo `mapstructure:"connection_info,omitempty"`
	Count              *int                   `mapstructure:"count,omitempty"`
	CumulativeTraffic  *NetworkTraffic        `mapstructure:"cumulative_traffic,omitempty"`
	DstEndpoint        *NetworkEndpoint       `mapstructure:"dst_endpoint,omitempty"`
	Duration           *int64                 `mapstructure:"duration,omitempty"`
	EndTime            *string                `mapstructure:"end_time,omitempty"`
	Enrichments        []Enrichment           `mapstructure:"enrichments,omitempty"`
	...
	Metadata           *Metadata              `mapstructure:"metadata"`
	Observables        []Observable           `mapstructure:"observables,omitempty"`
	ObservationPoint   *string                `mapstructure:"observation_point,omitempty"`
	ObservationPointID *int                   `mapstructure:"observation_point_id,omitempty"`
...
type GroupManagement struct {
	...
	StatusDetail   *string          `mapstructure:"status_detail,omitempty"`
	StatusID       *int             `mapstructure:"status_id,omitempty"`
	Subgroup       *Group           `mapstructure:"subgroup,omitempty"`
	Time           *string          `mapstructure:"time"`
	TimezoneOffset *int             `mapstructure:"timezone_offset,omitempty"`
	TypeName       *string          `mapstructure:"type_name,omitempty"`
	TypeUID        *int64           `mapstructure:"type_uid"`
...
func (o *GroupManagement) Validate() error {
	...
	if o.TypeUID != nil {
		switch *o.TypeUID {
		case 300600, 300601, 300602, 300603, 300604, 300605, 300606, 300607, 300608, 300699:
		default:
			errs = append(errs, fmt.Errorf("type_uid: invalid value %d", *o.TypeUID))
		}
	}
...
// IamAnalysisFinding represents the OCSF IAM Analysis Finding event class (UID: 2008).
...
type IamAnalysisFinding struct {
	AccessAnalysisResult      *AccessAnalysisResult      `mapstructure:"access_analysis_result,omitempty"`
	ActivityID                *int                       `mapstructure:"activity_id"`
	ActivityName              *string                    `mapstructure:"activity_name,omitempty"`
	Applications              []Application              `mapstructure:"applications,omitempty"`
	CategoryName              *string                    `mapstructure:"category_name,omitempty"`
	CategoryUID               *int                       `mapstructure:"category_uid"`
	ClassName                 *string                    `mapstructure:"class_name,omitempty"`
	ClassUID                  *int                       `mapstructure:"class_uid"`
	...
	Enrichments               []Enrichment               `mapstructure:"enrichments,omitempty"`
	FindingInfo               *FindingInfo               `mapstructure:"finding_info"`
	IdentityActivityMetrics   *IdentityActivityMetrics   `mapstructure:"identity_activity_metrics,omitempty"`
	Message                   *string                    `mapstructure:"message,omitempty"`
	Metadata                  *Metadata                  `mapstructure:"metadata"`
	Observables               []Observable               `mapstructure:"observables,omitempty"`
	PermissionAnalysisResults []PermissionAnalysisResult `mapstructure:"permission_analysis_results,omitempty"`
	RawData                   *string                    `mapstructure:"raw_data,omitempty"`
	RawDataHash               *Fingerprint               `mapstructure:"raw_data_hash,omitempty"`
	RawDataSize               *int64                     `mapstructure:"raw_data_size,omitempty"`
	Remediation               *Remediation               `mapstructure:"remediation,omitempty"`
...
// Validate checks required fields, constraints, and enum values for IamAnalysisFinding.
func (o *IamAnalysisFinding) Validate() error {
	var errs []error
	if o.ActivityID == nil {
		errs = append(errs, errors.New("activity_id is required"))
	}
	...
	if o.TypeUID != nil {
		switch *o.TypeUID {
		case 200800, 200801, 200802, 200803, 200899:
		default:
			errs = append(errs, fmt.Errorf("type_uid: invalid value %d", *o.TypeUID))
		}
	}
...
func (o *ModuleActivity) Validate() error {
	...
	if o.TypeUID != nil {
		switch *o.TypeUID {
		case 100500, 100501, 100502, 100503, 100599:
		default:
			errs = append(errs, fmt.Errorf("type_uid: invalid value %d", *o.TypeUID))
		}
	}
...
type NetworkActivity struct {
	...
	EndTime                 *string                `mapstructure:"end_time,omitempty"`
	Enrichments             []Enrichment           `mapstructure:"enrichments,omitempty"`
	IsSrcDstAssignmentKnown *bool                  `mapstructure:"is_src_dst_assignment_known,omitempty"`
	Ja4FingerprintList      []Ja4Fingerprint       `mapstructure:"ja4_fingerprint_list,omitempty"`
	Message                 *string                `mapstructure:"message,omitempty"`
	Metadata                *Metadata              `mapstructure:"metadata"`
	Observables             []Observable           `mapstructure:"observables,omitempty"`
...
// PeripheralActivity represents the OCSF Peripheral Activity event class (UID: 1010).
...
// Validate checks required fields, constraints, and enum values for PeripheralActivity.
func (o *PeripheralActivity) Validate() error {
	var errs []error
	if o.ActivityID == nil {
		errs = append(errs, errors.New("activity_id is required"))
	}
...
type ProcessActivity struct {
	...
	LaunchType           *string      `mapstructure:"launch_type,omitempty"`
	LaunchTypeID         *int         `mapstructure:"launch_type_id,omitempty"`
	Message              *string      `mapstructure:"message,omitempty"`
	Metadata             *Metadata    `mapstructure:"metadata"`
	Module               *Module      `mapstructure:"module,omitempty"`
	Observables          []Observable `mapstructure:"observables,omitempty"`
...
const (
	...
	ClassUIDIamAnalysisFinding                = 2008
	...
	ClassUIDPeripheralActivity                = 1010
...
func ValidateClass(classUID int, data any) error {
	...
	case ClassUIDHTTPActivity:
		...
		return obj.Validate()
	case ClassUIDIamAnalysisFinding:
		var obj IamAnalysisFinding
		if err := mapstructure.Decode(data, &obj); err != nil {
			return fmt.Errorf("decoding class: %w", err)
		}
		return obj.Validate()
	...
	case ClassUIDPatchState:
		...
		return obj.Validate()
	case ClassUIDPeripheralActivity:
		var obj PeripheralActivity
		if err := mapstructure.Decode(data, &obj); err != nil {
			return fmt.Errorf("decoding class: %w", err)
		}
		return obj.Validate()
...
var classFieldReqs = map[int]*fieldReqs{
	ClassUIDAccountChange: {
		...
		objectFields: map[string]string{"actor": "actor", "auth_factors": "auth_factor", "enrichments": "enrichment", "http_request": "http_request", "http_response": "http_response", "metadata": "metadata", "observables": "observable", "policies": "policy", "policy": "policy", "raw_data_hash": "fingerprint", "src_endpoint": "network_endpoint", "unmapped": "object", "user": "user", "user_result": "user"},
	...
	ClassUIDAdminGroupQuery: {
		...
		objectFields: map[string]string{"enrichments": "enrichment", "group": "group", "metadata": "metadata", "observables": "observable", "query_info": "query_info", "raw_data_hash": "fingerprint", "unmapped": "object", "users": "user"},
	...
	ClassUIDAPIActivity: {
		...
		objectFields: map[string]string{"actor": "actor", "api": "api", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "http_request": "http_request", "http_response": "http_response", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "resources": "resource_details", "src_endpoint": "network_endpoint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDApplicationError: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDApplicationLifecycle: {
		required:     []string{"activity_id", "app", "category_uid", "class_uid", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"app": "product", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	...
	ClassUIDAuthentication: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "severity_id", "time", "type_uid", "user"},
		objectFields: map[string]string{"actor": "actor", "auth_factors": "auth_factor", "authentication_token": "authentication_token", "certificate": "certificate", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "http_request": "http_request", "http_response": "http_response", "logon_process": "process", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "service": "service", "session": "session", "src_endpoint": "network_endpoint", "unmapped": "object", "user": "user"},
		fieldTypes:   map[string]string{"account_switch_type": "string", "account_switch_type_id": "integer", "activity_id": "integer", "activity_name": "string", "auth_protocol": "string", "auth_protocol_id": "integer", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "is_cleartext": "boolean", "is_mfa": "boolean", "is_new_logon": "boolean", "is_remote": "boolean", "logon_type": "string", "logon_type_id": "integer", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
		atLeastOne:   [][]string{{"dst_endpoint", "service"}},
	},
	ClassUIDAuthorizeSession: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "severity_id", "time", "type_uid", "user"},
		objectFields: map[string]string{"actor": "actor", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "group": "group", "http_request": "http_request", "http_response": "http_response", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "session": "session", "src_endpoint": "network_endpoint", "unmapped": "object", "user": "user"},
	...
	ClassUIDCloudResourcesInventoryInfo: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"cloud": "cloud", "container": "container", "database": "database", "databucket": "databucket", "enrichments": "enrichment", "idp": "idp", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "resources": "resource_details", "table": "table", "unmapped": "object"},
	...
	ClassUIDComplianceFinding: {
		...
		objectFields: map[string]string{"compliance": "compliance", "device": "device", "enrichments": "enrichment", "evidences": "evidences", "finding_info": "finding_info", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "remediation": "remediation", "resource": "resource_details", "resources": "resource_details", "unmapped": "object", "vendor_attributes": "vendor_attributes"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "comment": "string", "confidence": "string", "confidence_id": "integer", "confidence_score": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDConfigState: {
		required:     []string{"activity_id", "category_uid", "class_uid", "device", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"actor": "actor", "assessments": "assessment", "cis_benchmark_result": "cis_benchmark_result", "device": "device", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDDataSecurityFinding: {
		required:     []string{"activity_id", "category_uid", "class_uid", "finding_info", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"actor": "actor", "data_security": "data_security", "database": "database", "databucket": "databucket", "device": "device", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "file": "file", "finding_info": "finding_info", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "resources": "resource_details", "src_endpoint": "network_endpoint", "table": "table", "unmapped": "object", "vendor_attributes": "vendor_attributes"},
	...
	ClassUIDDatastoreActivity: {
		...
		objectFields: map[string]string{"actor": "actor", "database": "database", "databucket": "databucket", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "http_request": "http_request", "http_response": "http_response", "metadata": "metadata", "observables": "observable", "query_info": "query_info", "raw_data_hash": "fingerprint", "src_endpoint": "network_endpoint", "table": "table", "unmapped": "object"},
	...
	ClassUIDDetectionFinding: {
		required:     []string{"activity_id", "category_uid", "class_uid", "finding_info", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"anomaly_analyses": "anomaly_analysis", "device": "device", "enrichments": "enrichment", "evidences": "evidences", "finding_info": "finding_info", "malware": "malware", "malware_scan_info": "malware_scan_info", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "remediation": "remediation", "resources": "resource_details", "unmapped": "object", "vendor_attributes": "vendor_attributes", "vulnerabilities": "vulnerability"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "comment": "string", "confidence": "string", "confidence_id": "integer", "confidence_score": "integer", "count": "integer", "duration": "long", "end_time": "string", "impact": "string", "impact_id": "integer", "impact_score": "integer", "is_alert": "boolean", "message": "string", "raw_data": "string", "raw_data_size": "long", "risk_details": "string", "risk_level": "string", "risk_level_id": "integer", "risk_score": "integer", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDDeviceConfigStateChange: {
		required:     []string{"activity_id", "category_uid", "class_uid", "device", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"actor": "actor", "device": "device", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "prev_security_states": "security_state", "raw_data_hash": "fingerprint", "security_states": "security_state", "unmapped": "object"},
	...
	ClassUIDDhcpActivity: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"connection_info": "network_connection_info", "cumulative_traffic": "network_traffic", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "ja4_fingerprint_list": "ja4_fingerprint", "metadata": "metadata", "observables": "observable", "proxy": "network_proxy", "raw_data_hash": "fingerprint", "relay": "network_interface", "src_endpoint": "network_endpoint", "tls": "tls", "traffic": "network_traffic", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "app_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "is_renewal": "boolean", "lease_dur": "integer", "message": "string", "observation_point": "string", "observation_point_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "transaction_uid": "string", "type_name": "string", "type_uid": "long"},
		atLeastOne:   [][]string{{"dst_endpoint", "src_endpoint"}},
	},
	ClassUIDDNSActivity: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"answers": "dns_answer", "connection_info": "network_connection_info", "cumulative_traffic": "network_traffic", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "ja4_fingerprint_list": "ja4_fingerprint", "metadata": "metadata", "observables": "observable", "proxy": "network_proxy", "query": "dns_query", "raw_data_hash": "fingerprint", "src_endpoint": "network_endpoint", "tls": "tls", "traffic": "network_traffic", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "app_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "observation_point": "string", "observation_point_id": "integer", "query_time": "string", "raw_data": "string", "raw_data_size": "long", "rcode": "string", "rcode_id": "integer", "response_time": "string", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
		atLeastOne:   [][]string{{"dst_endpoint", "src_endpoint"}},
	},
	...
	ClassUIDEmailActivity: {
		...
		objectFields: map[string]string{"dst_endpoint": "network_endpoint", "email": "email", "email_auth": "email_auth", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "src_endpoint": "network_endpoint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "attempt": "integer", "banner": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "command": "string", "count": "integer", "direction": "string", "direction_id": "integer", "duration": "long", "end_time": "string", "from": "string", "message": "string", "message_trace_uid": "string", "protocol_name": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "smtp_hello": "string", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "to": "string", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDEmailFileActivity: {
		...
		objectFields: map[string]string{"enrichments": "enrichment", "file": "file", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "unmapped": "object"},
	...
	ClassUIDEmailURLActivity: {
		...
		objectFields: map[string]string{"enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "unmapped": "object", "url": "url"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "email_uid": "string", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDEntityManagement: {
		required:     []string{"activity_id", "category_uid", "class_uid", "entity", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"actor": "actor", "enrichments": "enrichment", "entity": "managed_entity", "entity_result": "managed_entity", "http_request": "http_request", "http_response": "http_response", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "src_endpoint": "network_endpoint", "unmapped": "object"},
	...
	ClassUIDEventLogActvity: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"actor": "actor", "device": "device", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "file": "file", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "src_endpoint": "network_endpoint", "unmapped": "object"},
	...
	ClassUIDEvidenceInfo: {
		...
		objectFields: map[string]string{"device": "device", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "query_evidence": "query_evidence", "query_info": "query_info", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "query_result": "string", "query_result_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDFileActivity: {
		...
		objectFields: map[string]string{"actor": "actor", "device": "device", "enrichments": "enrichment", "file": "file", "file_result": "file", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "unmapped": "object"},
	...
	ClassUIDFileHosting: {
		...
		objectFields: map[string]string{"actor": "actor", "connection_info": "network_connection_info", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "file": "file", "file_result": "file", "http_request": "http_request", "http_response": "http_response", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "src_endpoint": "network_endpoint", "unmapped": "object"},
	...
	ClassUIDFileQuery: {
		...
		objectFields: map[string]string{"enrichments": "enrichment", "file": "file", "metadata": "metadata", "observables": "observable", "query_info": "query_info", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "query_result": "string", "query_result_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDFileRemediationActivity: {
		...
		objectFields: map[string]string{"countermeasures": "d3fend", "enrichments": "enrichment", "file": "file", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "remediation": "remediation", "scan": "scan", "unmapped": "object"},
	...
	ClassUIDFolderQuery: {
		...
		objectFields: map[string]string{"enrichments": "enrichment", "folder": "file", "metadata": "metadata", "observables": "observable", "query_info": "query_info", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "query_result": "string", "query_result_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDFtpActivity: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"connection_info": "network_connection_info", "cumulative_traffic": "network_traffic", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "file": "file", "ja4_fingerprint_list": "ja4_fingerprint", "metadata": "metadata", "observables": "observable", "proxy": "network_proxy", "raw_data_hash": "fingerprint", "src_endpoint": "network_endpoint", "tls": "tls", "traffic": "network_traffic", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "app_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "codes": "integer", "command": "string", "command_responses": "string", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "name": "string", "observation_point": "string", "observation_point_id": "integer", "port": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type": "string", "type_name": "string", "type_uid": "long"},
		atLeastOne:   [][]string{{"dst_endpoint", "src_endpoint"}},
	},
	ClassUIDGroupManagement: {
		required:     []string{"activity_id", "category_uid", "class_uid", "group", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"actor": "actor", "enrichments": "enrichment", "group": "group", "http_request": "http_request", "http_response": "http_response", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "resource": "resource_details", "src_endpoint": "network_endpoint", "subgroup": "group", "unmapped": "object", "user": "user"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "privileges": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDHTTPActivity: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"connection_info": "network_connection_info", "cumulative_traffic": "network_traffic", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "file": "file", "http_cookies": "http_cookie", "http_request": "http_request", "http_response": "http_response", "ja4_fingerprint_list": "ja4_fingerprint", "metadata": "metadata", "observables": "observable", "proxy": "network_proxy", "raw_data_hash": "fingerprint", "src_endpoint": "network_endpoint", "tls": "tls", "traffic": "network_traffic", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "app_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "http_status": "integer", "message": "string", "observation_point": "string", "observation_point_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
		atLeastOne:   [][]string{{"http_request", "http_response"}},
	},
	ClassUIDIamAnalysisFinding: {
		required:     []string{"activity_id", "category_uid", "class_uid", "finding_info", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"access_analysis_result": "access_analysis_result", "applications": "application", "device": "device", "enrichments": "enrichment", "finding_info": "finding_info", "identity_activity_metrics": "identity_activity_metrics", "metadata": "metadata", "observables": "observable", "permission_analysis_results": "permission_analysis_result", "raw_data_hash": "fingerprint", "remediation": "remediation", "resources": "resource_details", "unmapped": "object", "user": "user", "vendor_attributes": "vendor_attributes"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "comment": "string", "confidence": "string", "confidence_id": "integer", "confidence_score": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
		atLeastOne:   [][]string{{"access_analysis_result", "applications", "identity_activity_metrics", "permission_analysis_results"}},
	},
	ClassUIDIncidentFinding: {
		...
		objectFields: map[string]string{"assignee": "user", "assignee_group": "group", "attacks": "attack", "enrichments": "enrichment", "finding_info_list": "finding_info", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "ticket": "ticket", "tickets": "ticket", "unmapped": "object", "vendor_attributes": "vendor_attributes"},
	...
	ClassUIDInventoryInfo: {
		required:     []string{"activity_id", "category_uid", "class_uid", "device", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"actor": "actor", "device": "device", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDJobQuery: {
		required:     []string{"activity_id", "category_uid", "class_uid", "job", "metadata", "query_result_id", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"enrichments": "enrichment", "job": "job", "metadata": "metadata", "observables": "observable", "query_info": "query_info", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "query_result": "string", "query_result_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDKernelActivity: {
		...
		objectFields: map[string]string{"actor": "actor", "device": "device", "enrichments": "enrichment", "kernel": "kernel", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDKernelExtensionActivity: {
		...
		objectFields: map[string]string{"actor": "actor", "device": "device", "driver": "kernel_driver", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDKernelObjectQuery: {
		...
		objectFields: map[string]string{"enrichments": "enrichment", "kernel": "kernel", "metadata": "metadata", "observables": "observable", "query_info": "query_info", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "query_result": "string", "query_result_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDMemoryActivity: {
		...
		objectFields: map[string]string{"actor": "actor", "device": "device", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "process": "process", "raw_data_hash": "fingerprint", "unmapped": "object"},
	...
	ClassUIDModuleActivity: {
		...
		objectFields: map[string]string{"actor": "actor", "device": "device", "enrichments": "enrichment", "metadata": "metadata", "module": "module", "observables": "observable", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDModuleQuery: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "module", "process", "query_result_id", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"enrichments": "enrichment", "metadata": "metadata", "module": "module", "observables": "observable", "process": "process", "query_info": "query_info", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "query_result": "string", "query_result_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDNetworkActivity: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"connection_info": "network_connection_info", "cumulative_traffic": "network_traffic", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "ja4_fingerprint_list": "ja4_fingerprint", "metadata": "metadata", "observables": "observable", "proxy": "network_proxy", "raw_data_hash": "fingerprint", "src_endpoint": "network_endpoint", "tls": "tls", "traffic": "network_traffic", "unmapped": "object", "url": "url"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "app_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "is_src_dst_assignment_known": "boolean", "message": "string", "observation_point": "string", "observation_point_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
		atLeastOne:   [][]string{{"dst_endpoint", "src_endpoint"}},
	},
	ClassUIDNetworkConnectionQuery: {
		...
		objectFields: map[string]string{"connection_info": "network_connection_info", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "process": "process", "query_info": "query_info", "raw_data_hash": "fingerprint", "unmapped": "object"},
	...
	ClassUIDNetworkFileActivity: {
		required:     []string{"activity_id", "actor", "category_uid", "class_uid", "file", "metadata", "severity_id", "src_endpoint", "time", "type_uid"},
		objectFields: map[string]string{"actor": "actor", "connection_info": "network_connection_info", "cumulative_traffic": "network_traffic", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "file": "file", "ja4_fingerprint_list": "ja4_fingerprint", "metadata": "metadata", "observables": "observable", "proxy": "network_proxy", "raw_data_hash": "fingerprint", "src_endpoint": "network_endpoint", "tls": "tls", "traffic": "network_traffic", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "app_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "expiration_time": "string", "message": "string", "observation_point": "string", "observation_point_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
		atLeastOne:   [][]string{{"dst_endpoint", "src_endpoint"}},
	},
	ClassUIDNetworkRemediationActivity: {
		...
		objectFields: map[string]string{"connection_info": "network_connection_info", "countermeasures": "d3fend", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "remediation": "remediation", "scan": "scan", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "command_uid": "string", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDNetworksQuery: {
		...
		objectFields: map[string]string{"enrichments": "enrichment", "metadata": "metadata", "network_interfaces": "network_interface", "observables": "observable", "query_info": "query_info", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "query_result": "string", "query_result_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDNtpActivity: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "severity_id", "time", "type_uid", "version"},
		objectFields: map[string]string{"connection_info": "network_connection_info", "cumulative_traffic": "network_traffic", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "ja4_fingerprint_list": "ja4_fingerprint", "metadata": "metadata", "observables": "observable", "proxy": "network_proxy", "raw_data_hash": "fingerprint", "src_endpoint": "network_endpoint", "tls": "tls", "traffic": "network_traffic", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "app_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "delay": "integer", "dispersion": "integer", "duration": "long", "end_time": "string", "message": "string", "observation_point": "string", "observation_point_id": "integer", "precision": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "stratum": "string", "stratum_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long", "version": "string"},
		atLeastOne:   [][]string{{"dst_endpoint", "src_endpoint"}},
	},
	ClassUIDOsintInventoryInfo: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "osint", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"actor": "actor", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "osint": "osint", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDPatchState: {
		required:     []string{"activity_id", "category_uid", "class_uid", "device", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"device": "device", "enrichments": "enrichment", "kb_article_list": "kb_article", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDPeripheralActivity: {
		required:     []string{"activity_id", "actor", "category_uid", "class_uid", "device", "metadata", "peripheral_device", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"actor": "actor", "device": "device", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "peripheral_device": "peripheral_device", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDPeripheralDeviceQuery: {
		...
		objectFields: map[string]string{"enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "peripheral_device": "peripheral_device", "query_info": "query_info", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "query_result": "string", "query_result_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDProcessActivity: {
		required:     []string{"activity_id", "actor", "category_uid", "class_uid", "device", "metadata", "process", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"actor": "actor", "device": "device", "enrichments": "enrichment", "metadata": "metadata", "module": "module", "observables": "observable", "process": "process", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "actual_permissions": "integer", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "exit_code": "integer", "injection_type": "string", "injection_type_id": "integer", "launch_type": "string", "launch_type_id": "integer", "message": "string", "raw_data": "string", "raw_data_size": "long", "requested_permissions": "integer", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDProcessQuery: {
		...
		objectFields: map[string]string{"enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "process": "process", "query_info": "query_info", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "query_result": "string", "query_result_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDProcessRemediationActivity: {
		...
		objectFields: map[string]string{"countermeasures": "d3fend", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "process": "process", "raw_data_hash": "fingerprint", "remediation": "remediation", "scan": "scan", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "command_uid": "string", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDRDPActivity: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"connection_info": "network_connection_info", "cumulative_traffic": "network_traffic", "device": "device", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "file": "file", "ja4_fingerprint_list": "ja4_fingerprint", "keyboard_info": "keyboard_info", "metadata": "metadata", "observables": "observable", "proxy": "network_proxy", "raw_data_hash": "fingerprint", "remote_display": "display", "request": "request", "response": "response", "src_endpoint": "network_endpoint", "tls": "tls", "traffic": "network_traffic", "unmapped": "object", "user": "user"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "app_name": "string", "capabilities": "string", "category_name": "string", "category_uid": "integer", "certificate_chain": "string", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "identifier_cookie": "string", "message": "string", "observation_point": "string", "observation_point_id": "integer", "protocol_ver": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
		atLeastOne:   [][]string{{"dst_endpoint", "src_endpoint"}},
	},
	ClassUIDRemediationActivity: {
		...
		objectFields: map[string]string{"countermeasures": "d3fend", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "remediation": "remediation", "scan": "scan", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "command_uid": "string", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDScanActivity: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "scan", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "policy": "policy", "raw_data_hash": "fingerprint", "scan": "scan", "unmapped": "object"},
	...
	ClassUIDScheduledJobActivity: {
		...
		objectFields: map[string]string{"actor": "actor", "device": "device", "enrichments": "enrichment", "job": "job", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDScriptActivity: {
		...
		objectFields: map[string]string{"actor": "actor", "device": "device", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "script": "script", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDSecurityFinding: {
		...
		objectFields: map[string]string{"analytic": "analytic", "attacks": "attack", "cis_csc": "cis_csc", "compliance": "compliance", "enrichments": "enrichment", "finding": "finding", "kill_chain": "kill_chain_phase", "malware": "malware", "metadata": "metadata", "observables": "observable", "process": "process", "raw_data_hash": "fingerprint", "resources": "resource_details", "unmapped": "object", "vulnerabilities": "vulnerability"},
	...
	ClassUIDServiceQuery: {
		...
		objectFields: map[string]string{"enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "query_info": "query_info", "raw_data_hash": "fingerprint", "service": "service", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "query_result": "string", "query_result_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDSessionQuery: {
		...
		objectFields: map[string]string{"enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "query_info": "query_info", "raw_data_hash": "fingerprint", "session": "session", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "query_result": "string", "query_result_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDSmbActivity: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"connection_info": "network_connection_info", "cumulative_traffic": "network_traffic", "dce_rpc": "dce_rpc", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "file": "file", "ja4_fingerprint_list": "ja4_fingerprint", "metadata": "metadata", "observables": "observable", "proxy": "network_proxy", "raw_data_hash": "fingerprint", "response": "response", "src_endpoint": "network_endpoint", "tls": "tls", "traffic": "network_traffic", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "app_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "client_dialects": "string", "command": "string", "count": "integer", "dialect": "string", "duration": "long", "end_time": "string", "message": "string", "observation_point": "string", "observation_point_id": "integer", "open_type": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "share": "string", "share_type": "string", "share_type_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "tree_uid": "string", "type_name": "string", "type_uid": "long"},
		atLeastOne:   [][]string{{"dst_endpoint", "src_endpoint"}},
	},
	ClassUIDSoftwareInfo: {
		required:     []string{"activity_id", "category_uid", "class_uid", "device", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"actor": "actor", "device": "device", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "package": "package", "product": "product", "raw_data_hash": "fingerprint", "sbom": "sbom", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDSSHActivity: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"client_hassh": "hassh", "connection_info": "network_connection_info", "cumulative_traffic": "network_traffic", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "file": "file", "ja4_fingerprint_list": "ja4_fingerprint", "metadata": "metadata", "observables": "observable", "proxy": "network_proxy", "raw_data_hash": "fingerprint", "server_hassh": "hassh", "src_endpoint": "network_endpoint", "tls": "tls", "traffic": "network_traffic", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "app_name": "string", "auth_type": "string", "auth_type_id": "integer", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "observation_point": "string", "observation_point_id": "integer", "protocol_ver": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
		atLeastOne:   [][]string{{"dst_endpoint", "src_endpoint"}},
	},
	ClassUIDStartupItemQuery: {
		...
		objectFields: map[string]string{"enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "query_info": "query_info", "raw_data_hash": "fingerprint", "startup_item": "startup_item", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "query_result": "string", "query_result_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDTunnelActivity: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"connection_info": "network_connection_info", "cumulative_traffic": "network_traffic", "device": "device", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "ja4_fingerprint_list": "ja4_fingerprint", "metadata": "metadata", "observables": "observable", "proxy": "network_proxy", "raw_data_hash": "fingerprint", "session": "session", "src_endpoint": "network_endpoint", "tls": "tls", "traffic": "network_traffic", "tunnel_interface": "network_interface", "unmapped": "object", "user": "user"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "app_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "observation_point": "string", "observation_point_id": "integer", "protocol_name": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "tunnel_type": "string", "tunnel_type_id": "integer", "type_name": "string", "type_uid": "long"},
	...
	ClassUIDUserAccess: {
		...
		objectFields: map[string]string{"actor": "actor", "enrichments": "enrichment", "http_request": "http_request", "http_response": "http_response", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "resource": "resource_details", "resources": "resource_details", "src_endpoint": "network_endpoint", "unmapped": "object", "user": "user"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "privileges": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDUserInventory: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "severity_id", "time", "type_uid", "user"},
		objectFields: map[string]string{"actor": "actor", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "unmapped": "object", "user": "user"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDUserQuery: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "query_result_id", "severity_id", "time", "type_uid", "user"},
		objectFields: map[string]string{"enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "query_info": "query_info", "raw_data_hash": "fingerprint", "unmapped": "object", "user": "user"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "query_result": "string", "query_result_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDVulnerabilityFinding: {
		...
		objectFields: map[string]string{"device": "device", "enrichments": "enrichment", "finding_info": "finding_info", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "resource": "resource_details", "resources": "resource_details", "unmapped": "object", "vendor_attributes": "vendor_attributes", "vulnerabilities": "vulnerability"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "comment": "string", "confidence": "string", "confidence_id": "integer", "confidence_score": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDWebResourceAccessActivity: {
		...
		objectFields: map[string]string{"enrichments": "enrichment", "http_request": "http_request", "http_response": "http_response", "metadata": "metadata", "observables": "observable", "proxy": "network_proxy", "raw_data_hash": "fingerprint", "src_endpoint": "network_endpoint", "tls": "tls", "unmapped": "object", "web_resources": "web_resource"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDWebResourcesActivity: {
		...
		objectFields: map[string]string{"dst_endpoint": "network_endpoint", "enrichments": "enrichment", "http_request": "http_request", "http_response": "http_response", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "src_endpoint": "network_endpoint", "tls": "tls", "unmapped": "object", "web_resources": "web_resource", "web_resources_result": "web_resource"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDWinPrefetchQuery: {
		...
		objectFields: map[string]string{"enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "query_info": "query_info", "raw_data_hash": "fingerprint", "unmapped": "object"},
	...
	ClassUIDWinRegistryKeyActivity: {
		...
		objectFields: map[string]string{"actor": "actor", "device": "device", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "prev_reg_key": "win/reg_key", "raw_data_hash": "fingerprint", "reg_key": "win/reg_key", "unmapped": "object"},
	...
	ClassUIDWinRegistryKeyQuery: {
		...
		objectFields: map[string]string{"enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "query_info": "query_info", "raw_data_hash": "fingerprint", "reg_key": "win/reg_key", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "query_result": "string", "query_result_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDWinRegistryValueActivity: {
		...
		objectFields: map[string]string{"actor": "actor", "device": "device", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "prev_reg_value": "win/reg_value", "raw_data_hash": "fingerprint", "reg_value": "win/reg_value", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDWinRegistryValueQuery: {
		...
		objectFields: map[string]string{"enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "query_info": "query_info", "raw_data_hash": "fingerprint", "reg_value": "win/reg_value", "unmapped": "object"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "query_result": "string", "query_result_id": "integer", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDWinWindowsResourceActivity: {
		...
		objectFields: map[string]string{"actor": "actor", "device": "device", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "unmapped": "object", "win_resource": "win/win_resource"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDWinWindowsServiceActivity: {
		...
		objectFields: map[string]string{"actor": "actor", "device": "device", "enrichments": "enrichment", "metadata": "metadata", "observables": "observable", "raw_data_hash": "fingerprint", "unmapped": "object", "win_service": "win/win_service"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "raw_data_size": "long", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
}
...
var objectFieldReqs = map[string]*fieldReqs{
	"access_analysis_result": {
		required:     []string{"accessors"},
		objectFields: map[string]string{"accessors": "user", "additional_restrictions": "additional_restriction", "condition_keys": "key_value_object"},
		fieldTypes:   map[string]string{"access_level": "string", "access_type": "string", "granted_privileges": "string"},
	},
	"account": {
	...
	"additional_restriction": {
		...
		fieldTypes:   map[string]string{"status": "string", "status_id": "integer"},
	},
	"advisory": {
		required:     []string{"uid"},
	...
	"analytic": {
		...
		fieldTypes:   map[string]string{"algorithm": "string", "category": "string", "desc": "string", "name": "string", "state": "string", "state_id": "integer", "type": "string", "type_id": "integer", "uid": "string", "version": "string"},
		atLeastOne:   [][]string{{"name", "uid"}},
	},
	"anomaly": {
	...
	"email": {
		...
		fieldTypes:   map[string]string{"cc": "string", "cc_mailboxes": "string", "delivered_to": "string", "delivered_to_list": "string", "from": "string", "from_list": "string", "from_mailbox": "string", "from_mailboxes": "string", "is_read": "boolean", "message_uid": "string", "raw_header": "string", "reply_to": "string", "reply_to_list": "string", "reply_to_mailboxes": "string", "return_path": "string", "sender": "string", "sender_mailbox": "string", "size": "long", "smtp_from": "string", "smtp_to": "string", "subject": "string", "to": "string", "to_mailboxes": "string", "uid": "string", "x_originating_ip": "string"},
	...
	"finding_info": {
		required:     []string{"uid"},
		objectFields: map[string]string{"analytic": "analytic", "attack_graph": "graph", "attacks": "attack", "kill_chain": "kill_chain_phase", "product": "product", "related_analytics": "analytic", "related_events": "related_event", "tags": "key_value_object", "traits": "trait"},
	...
	"function_invocation": {
		objectFields: map[string]string{"parameters": "parameter"},
		fieldTypes:   map[string]string{"error": "string", "return_value": "string"},
		atLeastOne:   [][]string{{"error", "parameters", "return_value"}},
	},
	"graph": {
	...
	"identity_activity_metrics": {
		objectFields: map[string]string{"programmatic_credentials": "programmatic_credential"},
		fieldTypes:   map[string]string{"first_seen_time": "string", "last_authentication_time": "string", "last_seen_time": "string", "password_last_used_time": "string"},
	},
	"idp": {
	...
	"logger": {
		...
		fieldTypes:   map[string]string{"event_uid": "string", "is_truncated": "boolean", "log_format": "string", "log_level": "string", "log_name": "string", "log_provider": "string", "log_version": "string", "logged_time": "string", "name": "string", "transmit_time": "string", "uid": "string", "untruncated_size": "integer", "version": "string"},
		atLeastOne:   [][]string{{"name", "uid"}},
	},
	"long_string": {
	...
	"metadata": {
		...
		objectFields: map[string]string{"extension": "extension", "extensions": "extension", "loggers": "logger", "product": "product", "reporter": "reporter", "tags": "key_value_object", "transformation_info_list": "transformation_info"},
		fieldTypes:   map[string]string{"correlation_uid": "string", "debug": "string", "event_code": "string", "is_truncated": "boolean", "labels": "string", "log_format": "string", "log_level": "string", "log_name": "string", "log_provider": "string", "log_source": "string", "log_version": "string", "logged_time": "string", "modified_time": "string", "original_event_uid": "string", "original_time": "string", "processed_time": "string", "profiles": "string", "sequence": "integer", "source": "string", "tenant_uid": "string", "transmit_time": "string", "type": "string", "uid": "string", "untruncated_size": "integer", "version": "string"},
	},
	"metric": {
		required:   []string{"name", "value"},
		fieldTypes: map[string]string{"name": "string", "value": "string"},
	...
	"module": {
		objectFields: map[string]string{"file": "file", "function_invocation": "function_invocation"},
		...
		atLeastOne:   [][]string{{"function_name", "load_type_id"}},
	},
	...
	"network_endpoint": {
		...
		fieldTypes:   map[string]string{"domain": "string", "hostname": "string", "instance_uid": "string", "interface_name": "string", "interface_uid": "string", "intermediate_ips": "string", "ip": "string", "isp": "string", "isp_org": "string", "mac": "string", "name": "string", "network_scope": "string", "network_scope_id": "integer", "port": "string", "subnet_uid": "string", "svc_name": "string", "type": "string", "type_id": "integer", "uid": "string", "vlan_uid": "string", "vpc_uid": "string", "zone": "string"},
		atLeastOne:   [][]string{{"domain", "hostname", "instance_uid", "interface_name", "interface_uid", "ip", "name", "svc_name", "uid"}},
	},
	"network_interface": {
		objectFields: map[string]string{"open_ports": "port_info"},
		...
		atLeastOne:   [][]string{{"hostname", "ip", "mac", "name", "uid"}},
	},
	"network_proxy": {
		objectFields: map[string]string{"agent_list": "agent", "autonomous_system": "autonomous_system", "hw_info": "device_hw_info", "location": "location", "os": "os", "owner": "user", "proxy_endpoint": "network_proxy"},
		fieldTypes:   map[string]string{"domain": "string", "hostname": "string", "instance_uid": "string", "interface_name": "string", "interface_uid": "string", "intermediate_ips": "string", "ip": "string", "isp": "string", "isp_org": "string", "mac": "string", "name": "string", "network_scope": "string", "network_scope_id": "integer", "port": "string", "subnet_uid": "string", "svc_name": "string", "type": "string", "type_id": "integer", "uid": "string", "vlan_uid": "string", "vpc_uid": "string", "zone": "string"},
	...
	"network_traffic": {
		...
		fieldTypes:   map[string]string{"bytes": "long", "bytes_in": "long", "bytes_missed": "long", "bytes_out": "long", "chunks": "long", "chunks_in": "long", "chunks_out": "long", "end_time": "string", "packets": "long", "packets_in": "long", "packets_out": "long", "start_time": "string"},
	},
	"node": {
		required:   []string{"uid"},
	...
	"observable": {
		required:     []string{"type_id"},
		objectFields: map[string]string{"reputation": "reputation"},
		fieldTypes:   map[string]string{"event_uid": "string", "name": "string", "type": "string", "type_id": "integer", "type_uid": "long", "value": "string"},
	},
	"observation": {
		required:     []string{"value"},
		objectFields: map[string]string{"timespan": "timespan"},
	...
	"parameter": {
		fieldTypes: map[string]string{"name": "string", "post_value": "string", "pre_value": "string"},
		atLeastOne: [][]string{{"name", "post_value", "pre_value"}},
	},
	"peripheral_device": {
		required:   []string{"name"},
		fieldTypes: map[string]string{"class": "string", "model": "string", "name": "string", "serial_number": "string", "type": "string", "type_id": "integer", "uid": "string", "vendor_id_list": "string", "vendor_name": "string"},
		atLeastOne: [][]string{{"name", "uid"}},
	},
	"permission_analysis_result": {
		objectFields: map[string]string{"condition_keys": "key_value_object", "policy": "policy"},
		fieldTypes:   map[string]string{"granted_privileges": "string", "unused_privileges_count": "integer", "unused_services_count": "integer"},
	},
	"policy": {
		objectFields: map[string]string{"group": "group"},
		fieldTypes:   map[string]string{"desc": "string", "is_applied": "boolean", "name": "string", "type": "string", "uid": "string", "version": "string"},
		atLeastOne:   [][]string{{"name", "type", "uid"}},
	},
	"port_info": {
		required:   []string{"port"},
		fieldTypes: map[string]string{"port": "string", "protocol_name": "string", "protocol_num": "integer"},
	},
	"process": {
		objectFields: map[string]string{"ancestry": "process_entity", "environment_variables": "environment_variable", "file": "file", "hosted_services": "win/win_service", "parent_process": "process", "session": "session", "user": "user", "xattributes": "object"},
		fieldTypes:   map[string]string{"cmd_line": "string", "cpid": "string", "created_time": "string", "integrity": "string", "integrity_id": "integer", "lineage": "string", "loaded_modules": "string", "name": "string", "path": "string", "pid": "integer", "ptid": "long", "sandbox": "string", "terminated_time": "string", "tid": "integer", "uid": "string", "working_directory": "string"},
	...
	"programmatic_credential": {
		required:   []string{"uid"},
		fieldTypes: map[string]string{"last_used_time": "string", "type": "string", "uid": "string"},
	},
	"query_evidence": {
	...
	"related_event": {
		...
		fieldTypes:   map[string]string{"count": "integer", "created_time": "string", "desc": "string", "first_seen_time": "string", "last_seen_time": "string", "modified_time": "string", "product_uid": "string", "severity": "string", "severity_id": "integer", "status": "string", "title": "string", "type": "string", "type_name": "string", "type_uid": "long", "uid": "string"},
	},
	"remediation": {
	...
	"reporter": {
		objectFields: map[string]string{"org": "organization"},
		fieldTypes:   map[string]string{"hostname": "string", "ip": "string", "name": "string", "uid": "string"},
		atLeastOne:   [][]string{{"hostname", "ip", "name", "uid"}},
	},
	"reputation": {
	...
	"resource_details": {
		...
		fieldTypes:   map[string]string{"created_time": "string", "criticality": "string", "hostname": "string", "ip": "string", "is_backed_up": "boolean", "labels": "string", "modified_time": "string", "name": "string", "namespace": "string", "role": "string", "role_id": "integer", "type": "string", "uid": "string", "uid_alt": "string", "version": "string"},
		atLeastOne:   [][]string{{"name", "uid"}},
	},
	"response": {
		objectFields: map[string]string{"containers": "container"},
	...
	"user": {
		objectFields: map[string]string{"account": "account", "groups": "group", "ldap_person": "ldap_person", "org": "organization", "programmatic_credentials": "programmatic_credential"},
	...
	"win/reg_value": {
		...
		fieldTypes: map[string]string{"is_default": "boolean", "is_system": "boolean", "modified_time": "string", "name": "string", "path": "string", "reg_binary_data": "string", "reg_integer_data": "long", "reg_string_data": "string", "reg_string_list_data": "string", "type": "string", "type_id": "integer"},
	},
	"win/win_resource": {
		required:     []string{"type_id"},
		objectFields: map[string]string{"tags": "key_value_object"},
	...
	"win/win_service": {
		required:     []string{"name"},
		objectFields: map[string]string{"hosting_process": "process_entity", "service_dll_file": "file", "service_file": "file", "tags": "key_value_object"},
