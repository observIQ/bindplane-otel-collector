// Code generated by gen.go from https://schema.ocsf.io/1.4.0/export/schema. DO NOT EDIT.
...
// D3fTechnique represents the OCSF MITRE DEFEND™ Technique object.
...
func (o *ProcessEntity) Validate() error {
	var errs []error
	if o.CmdLine == nil && o.Name == nil && o.Path == nil && o.Pid == nil && o.UID == nil {
		errs = append(errs, errors.New("at least one of [cmd_line, name, path, pid, uid] must be set"))
	}
	return errors.Join(errs...)
}
...
// SubTechnique represents the OCSF MITRE ATT&CK® Sub Technique object.
...
// Tactic represents the OCSF MITRE ATT&CK® Tactic object.
// The MITRE ATT&CK® Tactic object describes the tactic ID and/or name that is associated to an attack, as defined by ATT&CK® Matrix.
type Tactic struct {
	Name   *string `mapstructure:"name,omitempty"`
	SrcURL *string `mapstructure:"src_url,omitempty"`
	UID    *string `mapstructure:"uid,omitempty"`
...
// Technique represents the OCSF MITRE ATT&CK® Technique object.
...
func (o *Timespan) Validate() error {
	var errs []error
	if o.Duration == nil && o.DurationDays == nil && o.DurationHours == nil && o.DurationMins == nil && o.DurationMonths == nil && o.DurationSecs == nil && o.DurationWeeks == nil && o.DurationYears == nil {
		errs = append(errs, errors.New("at least one of [duration, duration_days, duration_hours, duration_mins, duration_months, duration_secs, duration_weeks, duration_years] must be set"))
	}
	if o.TypeID != nil {
		switch *o.TypeID {
		case 0, 1, 2, 3, 4, 5, 6, 7, 8, 99:
...
var classFieldReqs = map[int]*fieldReqs{
	ClassUIDAccountChange: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDAdminGroupQuery: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "query_result": "string", "query_result_id": "integer", "raw_data": "string", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDAirborneBroadcastActivity: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "protocol_name": "string", "raw_data": "string", "rssi": "integer", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	...
	ClassUIDAuthentication: {
		required:     []string{"activity_id", "category_uid", "class_uid", "metadata", "severity_id", "time", "type_uid", "user"},
		objectFields: map[string]string{"actor": "actor", "auth_factors": "auth_factor", "certificate": "certificate", "dst_endpoint": "network_endpoint", "enrichments": "enrichment", "http_request": "http_request", "http_response": "http_response", "logon_process": "process", "metadata": "metadata", "observables": "observable", "service": "service", "session": "session", "src_endpoint": "network_endpoint", "unmapped": "object", "user": "user"},
	...
	ClassUIDAuthorizeSession: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "privileges": "string", "raw_data": "string", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	...
	ClassUIDCloudResourcesInventoryInfo: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "region": "string", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	...
	ClassUIDComplianceFinding: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "comment": "string", "confidence": "string", "confidence_id": "integer", "confidence_score": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDConfigState: {
	...
	ClassUIDDataSecurityFinding: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "comment": "string", "confidence": "string", "confidence_id": "integer", "confidence_score": "integer", "count": "integer", "duration": "long", "end_time": "string", "impact": "string", "impact_id": "integer", "impact_score": "integer", "is_alert": "boolean", "message": "string", "raw_data": "string", "risk_details": "string", "risk_level": "string", "risk_level_id": "integer", "risk_score": "integer", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	...
	ClassUIDDetectionFinding: {
		required:     []string{"activity_id", "category_uid", "class_uid", "finding_info", "metadata", "severity_id", "time", "type_uid"},
		objectFields: map[string]string{"device": "device", "enrichments": "enrichment", "evidences": "evidences", "finding_info": "finding_info", "metadata": "metadata", "observables": "observable", "remediation": "remediation", "resources": "resource_details", "unmapped": "object", "vendor_attributes": "vendor_attributes", "vulnerabilities": "vulnerability"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "comment": "string", "confidence": "string", "confidence_id": "integer", "confidence_score": "integer", "count": "integer", "duration": "long", "end_time": "string", "impact": "string", "impact_id": "integer", "impact_score": "integer", "is_alert": "boolean", "message": "string", "raw_data": "string", "risk_details": "string", "risk_level": "string", "risk_level_id": "integer", "risk_score": "integer", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDDeviceConfigStateChange: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "prev_security_level": "string", "prev_security_level_id": "integer", "raw_data": "string", "security_level": "string", "security_level_id": "integer", "severity": "string", "severity_id": "integer", "start_time": "string", "state": "string", "state_id": "integer", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	...
	ClassUIDDNSActivity: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "app_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "query_time": "string", "raw_data": "string", "rcode": "string", "rcode_id": "integer", "response_time": "string", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
		atLeastOne:   [][]string{{"dst_endpoint", "src_endpoint"}},
	},
	...
	ClassUIDEmailActivity: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "attempt": "integer", "banner": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "command": "string", "count": "integer", "direction": "string", "direction_id": "integer", "duration": "long", "end_time": "string", "message": "string", "message_trace_uid": "string", "protocol_name": "string", "raw_data": "string", "severity": "string", "severity_id": "integer", "smtp_hello": "string", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDEmailFileActivity: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "email_uid": "string", "end_time": "string", "message": "string", "raw_data": "string", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	...
	ClassUIDEventLogActvity: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "log_name": "string", "log_provider": "string", "log_type": "string", "log_type_id": "integer", "message": "string", "raw_data": "string", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	...
	ClassUIDFileActivity: {
		...
		fieldTypes:   map[string]string{"access_mask": "integer", "activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "component": "string", "connection_uid": "string", "count": "integer", "create_mask": "string", "duration": "long", "end_time": "string", "file_diff": "string", "message": "string", "raw_data": "string", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDFileHosting: {
		...
		fieldTypes:   map[string]string{"access_list": "string", "access_mask": "integer", "activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "expiration_time": "string", "message": "string", "raw_data": "string", "severity": "string", "severity_id": "integer", "share": "string", "share_type": "string", "share_type_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDFileQuery: {
	...
	ClassUIDHTTPActivity: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "app_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "http_status": "integer", "message": "string", "raw_data": "string", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	...
	ClassUIDIncidentFinding: {
		...
		objectFields: map[string]string{"assignee": "user", "assignee_group": "group", "attacks": "attack", "enrichments": "enrichment", "finding_info_list": "finding_info", "metadata": "metadata", "observables": "observable", "ticket": "ticket", "unmapped": "object", "vendor_attributes": "vendor_attributes"},
	...
	ClassUIDMemoryActivity: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "actual_permissions": "integer", "base_address": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "requested_permissions": "integer", "severity": "string", "severity_id": "integer", "size": "long", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	...
	ClassUIDNetworkActivity: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "app_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "raw_data": "string", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
		atLeastOne:   [][]string{{"dst_endpoint", "src_endpoint"}},
	},
	ClassUIDNetworkConnectionQuery: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "query_result": "string", "query_result_id": "integer", "raw_data": "string", "severity": "string", "severity_id": "integer", "start_time": "string", "state": "string", "state_id": "integer", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDNetworkFileActivity: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "app_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "expiration_time": "string", "message": "string", "raw_data": "string", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
		atLeastOne:   [][]string{{"dst_endpoint", "src_endpoint"}},
	},
	...
	ClassUIDNtpActivity: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "app_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "delay": "integer", "dispersion": "integer", "duration": "long", "end_time": "string", "message": "string", "precision": "integer", "raw_data": "string", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "stratum": "string", "stratum_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long", "version": "string"},
		atLeastOne:   [][]string{{"dst_endpoint", "src_endpoint"}},
	},
	...
	ClassUIDSmbActivity: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "app_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "client_dialects": "string", "command": "string", "count": "integer", "dialect": "string", "duration": "long", "end_time": "string", "message": "string", "open_type": "string", "raw_data": "string", "severity": "string", "severity_id": "integer", "share": "string", "share_type": "string", "share_type_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "tree_uid": "string", "type_name": "string", "type_uid": "long"},
		atLeastOne:   [][]string{{"dst_endpoint", "src_endpoint"}},
	},
	...
	ClassUIDTunnelActivity: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "app_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "protocol_name": "string", "raw_data": "string", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "tunnel_type": "string", "tunnel_type_id": "integer", "type_name": "string", "type_uid": "long"},
	...
	ClassUIDUserAccess: {
		...
		objectFields: map[string]string{"actor": "actor", "enrichments": "enrichment", "http_request": "http_request", "http_response": "http_response", "metadata": "metadata", "observables": "observable", "resource": "resource_details", "src_endpoint": "network_endpoint", "unmapped": "object", "user": "user"},
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "message": "string", "privileges": "string", "raw_data": "string", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	...
	ClassUIDWinPrefetchQuery: {
		...
		fieldTypes:   map[string]string{"activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "duration": "long", "end_time": "string", "last_run_time": "string", "message": "string", "name": "string", "query_result": "string", "query_result_id": "integer", "raw_data": "string", "run_count": "integer", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
	ClassUIDWinRegistryKeyActivity: {
		...
		fieldTypes:   map[string]string{"access_mask": "integer", "activity_id": "integer", "activity_name": "string", "category_name": "string", "category_uid": "integer", "class_name": "string", "class_uid": "integer", "count": "integer", "create_mask": "string", "duration": "long", "end_time": "string", "message": "string", "open_mask": "integer", "raw_data": "string", "severity": "string", "severity_id": "integer", "start_time": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_id": "integer", "time": "string", "timezone_offset": "integer", "type_name": "string", "type_uid": "long"},
	},
...
var objectFieldReqs = map[string]*fieldReqs{
	...
	"affected_package": {
		...
		fieldTypes:   map[string]string{"architecture": "string", "cpe_name": "string", "epoch": "integer", "fixed_in_version": "string", "license": "string", "name": "string", "package_manager": "string", "path": "string", "purl": "string", "release": "string", "type": "string", "type_id": "integer", "vendor_name": "string", "version": "string"},
	},
	"agent": {
	...
	"compliance": {
		...
		objectFields: map[string]string{"compliance_references": "kb_article", "compliance_standards": "kb_article", "control_parameters": "key_value_object"},
		fieldTypes:   map[string]string{"control": "string", "requirements": "string", "standards": "string", "status": "string", "status_code": "string", "status_detail": "string", "status_details": "string", "status_id": "integer"},
	},
	"container": {
	...
	"databucket": {
		required:     []string{"type_id"},
		objectFields: map[string]string{"agent_list": "agent", "encryption_details": "encryption_details", "file": "file", "group": "group", "groups": "group", "owner": "user", "tags": "key_value_object"},
		fieldTypes:   map[string]string{"created_time": "string", "criticality": "string", "desc": "string", "hostname": "string", "ip": "string", "is_encrypted": "boolean", "is_public": "boolean", "labels": "string", "modified_time": "string", "name": "string", "namespace": "string", "size": "long", "type": "string", "type_id": "integer", "uid": "string", "version": "string"},
		atLeastOne:   [][]string{{"name", "uid"}},
	},
	"dce_rpc": {
	...
	"device": {
		...
		fieldTypes:   map[string]string{"autoscale_uid": "string", "boot_time": "string", "created_time": "string", "desc": "string", "domain": "string", "first_seen_time": "string", "hostname": "string", "hypervisor": "string", "imei": "string", "imei_list": "string", "instance_uid": "string", "interface_name": "string", "interface_uid": "string", "ip": "string", "is_compliant": "boolean", "is_managed": "boolean", "is_personal": "boolean", "is_trusted": "boolean", "last_seen_time": "string", "mac": "string", "model": "string", "modified_time": "string", "name": "string", "os_machine_uuid": "string", "region": "string", "risk_level": "string", "risk_level_id": "integer", "risk_score": "integer", "subnet": "string", "subnet_uid": "string", "type": "string", "type_id": "integer", "uid": "string", "uid_alt": "string", "vendor_name": "string", "vlan_uid": "string", "vpc_uid": "string", "zone": "string"},
	...
	"discovery_details": {
		objectFields: map[string]string{"occurrence_details": "occurrence_details"},
	...
	"email": {
		...
		fieldTypes:   map[string]string{"cc": "string", "cc_mailboxes": "string", "delivered_to": "string", "delivered_to_list": "string", "from": "string", "from_mailbox": "string", "message_uid": "string", "raw_header": "string", "reply_to": "string", "reply_to_mailboxes": "string", "size": "long", "smtp_from": "string", "smtp_to": "string", "subject": "string", "to": "string", "to_mailboxes": "string", "uid": "string", "x_originating_ip": "string"},
	...
	"finding_info": {
		required:     []string{"uid"},
		objectFields: map[string]string{"analytic": "analytic", "attacks": "attack", "kill_chain": "kill_chain_phase", "product": "product", "related_analytics": "analytic", "related_events": "related_event", "tags": "key_value_object"},
	...
	"metadata": {
		...
		objectFields: map[string]string{"extension": "extension", "extensions": "extension", "loggers": "logger", "product": "product", "tags": "key_value_object"},
	...
	"osint": {
		required:     []string{"type_id", "value"},
		objectFields: map[string]string{"answers": "dns_answer", "attacks": "attack", "autonomous_system": "autonomous_system", "email": "email", "email_auth": "email_auth", "file": "file", "kill_chain": "kill_chain_phase", "location": "location", "related_analytics": "analytic", "reputation": "reputation", "script": "script", "signatures": "digital_signature", "vulnerabilities": "vulnerability", "whois": "whois"},
		fieldTypes:   map[string]string{"comment": "string", "confidence": "string", "confidence_id": "integer", "name": "string", "src_url": "string", "subdomains": "string", "subnet": "string", "tlp": "string", "type": "string", "type_id": "integer", "uid": "string", "value": "string", "vendor_name": "string"},
		atLeastOne:   [][]string{{"name", "uid"}},
	},
	"package": {
		required:     []string{"name", "version"},
		objectFields: map[string]string{"hash": "fingerprint"},
		fieldTypes:   map[string]string{"architecture": "string", "cpe_name": "string", "epoch": "integer", "license": "string", "name": "string", "purl": "string", "release": "string", "type": "string", "type_id": "integer", "vendor_name": "string", "version": "string"},
	},
	"peripheral_device": {
	...
	"process": {
		...
		fieldTypes:   map[string]string{"cmd_line": "string", "created_time": "string", "integrity": "string", "integrity_id": "integer", "lineage": "string", "loaded_modules": "string", "name": "string", "path": "string", "pid": "integer", "sandbox": "string", "terminated_time": "string", "tid": "integer", "uid": "string", "working_directory": "string"},
		atLeastOne:   [][]string{{"pid", "uid"}},
	},
	"process_entity": {
		fieldTypes: map[string]string{"cmd_line": "string", "created_time": "string", "name": "string", "path": "string", "pid": "integer", "uid": "string"},
		atLeastOne: [][]string{{"cmd_line", "name", "path", "pid", "uid"}},
	},
	"product": {
	...
	"related_event": {
		required:     []string{"uid"},
		objectFields: map[string]string{"attacks": "attack", "kill_chain": "kill_chain_phase", "observables": "observable", "product": "product", "tags": "key_value_object"},
	...
	"resource_details": {
		objectFields: map[string]string{"agent_list": "agent", "group": "group", "owner": "user", "tags": "key_value_object"},
		fieldTypes:   map[string]string{"criticality": "string", "hostname": "string", "ip": "string", "labels": "string", "name": "string", "namespace": "string", "type": "string", "uid": "string", "version": "string"},
		atLeastOne:   [][]string{{"name", "uid"}},
	},
	"response": {
		objectFields: map[string]string{"containers": "container"},
	...
	"sbom": {
		...
		fieldTypes:   map[string]string{"created_time": "string"},
	},
	"scan": {
		required:   []string{"type_id"},
	...
	"ticket": {
		fieldTypes: map[string]string{"src_url": "string", "title": "string", "type": "string", "type_id": "integer", "uid": "string"},
		atLeastOne: [][]string{{"src_url", "uid"}},
	},
	"timespan": {
		fieldTypes: map[string]string{"duration": "long", "duration_days": "integer", "duration_hours": "integer", "duration_mins": "integer", "duration_months": "integer", "duration_secs": "integer", "duration_weeks": "integer", "duration_years": "integer", "type": "string", "type_id": "integer"},
		atLeastOne: [][]string{{"duration", "duration_days", "duration_hours", "duration_mins", "duration_months", "duration_secs", "duration_weeks", "duration_years"}},
	},
	"tls": {
	...
	"user": {
		...
		fieldTypes:   map[string]string{"credential_uid": "string", "domain": "string", "email_addr": "string", "forward_addr": "string", "full_name": "string", "has_mfa": "boolean", "name": "string", "phone_number": "string", "risk_level": "string", "risk_level_id": "integer", "risk_score": "integer", "type": "string", "type_id": "integer", "uid": "string", "uid_alt": "string"},
	...
	"vulnerability": {
		...
		fieldTypes:   map[string]string{"desc": "string", "exploit_last_seen_time": "string", "first_seen_time": "string", "fix_available": "boolean", "is_exploit_available": "boolean", "is_fix_available": "boolean", "kb_articles": "string", "last_seen_time": "string", "references": "string", "related_vulnerabilities": "string", "severity": "string", "title": "string", "vendor_name": "string"},
	...
	"whois": {
		...
		fieldTypes:   map[string]string{"created_time": "string", "dnssec_status": "string", "dnssec_status_id": "integer", "domain": "string", "email_addr": "string", "last_seen_time": "string", "name_servers": "string", "phone_number": "string", "registrar": "string", "status": "string", "subdomains": "string", "subnet": "string"},
	},
	"win/reg_key": {
