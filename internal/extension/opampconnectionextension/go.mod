...
require (
	...
	github.com/observiq/bindplane-otel-contrib/extension/pebbleextension v1.14.0
...
require (
	...
	github.com/observiq/bindplane-otel-contrib/pkg/snapshot v1.14.1-0.20260917150221-bd6c16522a80 // indirect
