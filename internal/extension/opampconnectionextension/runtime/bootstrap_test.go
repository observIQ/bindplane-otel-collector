...
// Path-default tests for getDefaultCollectorConfigPaths /
// getDefaultLoggingConfigPath / getDefaultManagerConfigPath live alongside
// those helpers in the cmd/collector main package (and the ocb-driven
// internal/extension/opampconnectionextension/cmd/main/main.go); they aren't part of the runtime package contract.
...
func TestCheckManagerNoConfig(t *testing.T) {
	...
	tmp := "\000"
	err = bootstrapManagerConfig(&tmp)
	require.Error(t, err)
}
