...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/cmd/opampsupervisor v0.145.0
...
require (
	...
	go.opentelemetry.io/collector/confmap/provider/fileprovider v1.51.0 // indirect
