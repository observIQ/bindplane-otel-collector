...
require (
	github.com/observiq/bindplane-otel-collector/internal/rehydration v1.80.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/stanza v0.130.0
	...
	go.opentelemetry.io/collector/extension/xextension v0.130.1
