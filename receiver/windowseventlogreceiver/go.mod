module github.com/observiq/bindplane-otel-collector/receiver/windowseventlogreceiver
...
require (
	...
	go.opentelemetry.io/collector/extension v1.45.1-0.20251105131800-09a271914bdc // indirect
