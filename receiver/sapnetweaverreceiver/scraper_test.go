...
import (
	...
	"github.com/observiq/bindplane-otel-collector/receiver/sapnetweaverreceiver/internal/mocks"
...
func TestScraperScrape(t *testing.T) {
	...
	scraper := newSapNetweaverScraper(receivertest.NewNopSettings(typ), cfg)
