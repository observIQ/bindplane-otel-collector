...
require (
	...
	go.opentelemetry.io/collector/filter v0.137.0
	...
	go.opentelemetry.io/collector/scraper v0.137.0
	go.opentelemetry.io/collector/scraper/scraperhelper v0.137.0
