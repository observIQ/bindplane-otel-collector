...
func (_m *MockBlobClient) ListBlobs(ctx context.Context, container string, prefix *string, marker *string) ([]*azureblob.BlobInfo, *string, error) {
	...
	var r0 []*azureblob.BlobInfo
	var r1 *string
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *string, *string) ([]*azureblob.BlobInfo, *string, error)); ok {
		return rf(ctx, container, prefix, marker)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, *string, *string) []*azureblob.BlobInfo); ok {
		r0 = rf(ctx, container, prefix, marker)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*azureblob.BlobInfo)
		}
	}
...
func (_c *MockBlobClient_ListBlobs_Call) RunAndReturn(run func(context.Context, string, *string, *string) ([]*azureblob.BlobInfo, *string, error)) *MockBlobClient_ListBlobs_Call {
	_c.Call.Return(run)
	return _c
}
