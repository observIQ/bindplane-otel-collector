...
require (
	...
	github.com/observiq/bindplane-otel-collector/internal/rehydration v1.85.2
	github.com/observiq/bindplane-otel-collector/internal/storageclient v1.85.2
	github.com/observiq/bindplane-otel-collector/internal/testutils v1.85.2
