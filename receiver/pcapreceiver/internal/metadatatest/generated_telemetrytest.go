...
func NewSettings(tt *componenttest.Telemetry) receiver.Settings {
	...
	set.ID = component.NewID(component.MustNewType("pcap"))
...
func AssertEqualPcapPacketsCaptured(t *testing.T, tt *componenttest.Telemetry, dps []metricdata.DataPoint[int64], opts ...metricdatatest.Option) {
	want := metricdata.Metrics{
		...
		Description: "The number of packets captured by the PCAP receiver",
		Unit:        "{packets}",
	...
	got, err := tt.GetMetric("otelcol_pcap.packets_captured")
