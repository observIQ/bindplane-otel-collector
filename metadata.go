...
// Package awss3eventreceiver implements a receiver that consumes S3 event notifications and processes the S3 objects.
...
// TypeStr is the string representation of the AWS S3 Event Receiver
