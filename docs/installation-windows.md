...
> **Note:** The install script is available as of release v2.0.1-beta.13. For earlier versions, see the [manual installation](#manual-installation) instructions below.
