...
require (
	github.com/honeycombio/enhance-indexing-s3-exporter/enhanceindexings3exporter v0.0.16
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/batchperresourceattr v0.150.0 // indirect; indi72.0
