...
func newAgentClientConnections(connections *connections, pool *connectionPool) *agentClientConnections {
...
func (a *agentClientConnections) assignedAgentConnection(agentID string) (*connection, bool) {
	a.mtx.Lock()
	defer a.mtx.Unlock()
