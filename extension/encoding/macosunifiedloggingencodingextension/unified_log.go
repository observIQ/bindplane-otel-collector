...
// 		catalogOffset += totalChunkSize + int(utils.PaddingSize(chunkDataSize, 8))
...
// 			// Continue to next chunk without adding the template entry
// 			offset += totalChunkSize + int(utils.PaddingSize(chunkDataSize, 8))
// 			entryCount++
// 			continue
// 		case 0x6003:
// 			// Statedump chunk
...
// 		paddingBytes := utils.PaddingSize(chunkDataSize, 8)
