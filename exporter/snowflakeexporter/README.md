...
Now a new user needs to be created that the BDOT can login as. The user should also have the default role assigned as `SYSADMIN`, although it isn't necessary.
