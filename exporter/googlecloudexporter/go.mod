...
require (
	...
	github.com/observiq/bindplane-otel-collector/internal/version v1.71.0
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/googlecloudexporter v0.118.0
