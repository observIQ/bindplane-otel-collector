...
require (
	github.com/observiq/bindplane-otel-collector/internal/expr v1.73.1
	...
	go.opentelemetry.io/collector/config/configtls v1.28.0
...
require (
	...
	go.opentelemetry.io/collector/config/confignet v1.28.0
