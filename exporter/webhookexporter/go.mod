...
require (
	github.com/observiq/bindplane-otel-collector/internal/exporterutils v1.94.2
	...
	go.opentelemetry.io/collector/exporter/exporterhelper/xexporterhelper v0.146.1
