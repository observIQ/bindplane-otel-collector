module github.com/observiq/bindplane-otel-collector/exporter/webhookexporter

go 1.24.11

require (
	github.com/observiq/bindplane-otel-collector/internal/version v1.92.1
	...
	go.opentelemetry.io/collector/config/configretry v1.51.0
	...
	go.opentelemetry.io/collector/exporter/exporterhelper/xexporterhelper v0.145.0
