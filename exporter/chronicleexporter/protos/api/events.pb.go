...
const file_events_proto_rawDesc = "" +
	"\n" +
	"\fevents.proto\x12\x16malachite.ingestion.v2\x1a\fsource.proto\x1a\vstats.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x9a\x02\n" +
	"\x05Event\x128\n" +
	"\ttimestamp\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12C\n" +
	"\x0fcollection_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x0ecollectionTime\x12J\n" +
	"\vagent_stats\x18\x18 \x01(\v2'.malachite.ingestion.v2.AgentStatsEventH\x00R\n" +
	"agentStats\x12;\n" +
	"\x06source\x18\a \x01(\v2#.malachite.ingestion.v2.EventSourceR\x06sourceB\t\n" +
	"\apayload\"\xbc\x02\n" +
	"\n" +
	"EventBatch\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\fR\x02id\x12;\n" +
	"\x06source\x18\x02 \x01(\v2#.malachite.ingestion.v2.EventSourceR\x06source\x12@\n" +
	"\x04type\x18\x03 \x01(\x0e2,.malachite.ingestion.v2.EventBatch.EventTypeR\x04type\x125\n" +
	"\x06events\x18\x04 \x03(\v2\x1d.malachite.ingestion.v2.EventR\x06events\x129\n" +
	"\n" +
