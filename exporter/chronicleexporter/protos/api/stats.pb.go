...
const file_stats_proto_rawDesc = "" +
	"\n" +
	"\vstats.proto\x12\x16malachite.ingestion.v2\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfc\x04\n" +
	...
	"\bagent_id\x18\x04 \x01(\fR\aagentId\x12L\n" +
	"\x0ereceiver_stats\x18\x05 \x03(\v2%.malachite.ingestion.v2.ReceiverStatsR\rreceiverStats\x12O\n" +
	"\x0fprocessor_stats\x18\x06 \x03(\v2&.malachite.ingestion.v2.ProcessorStatsR\x0eprocessorStats\x12L\n" +
	"\x0eexporter_stats\x18\a \x03(\v2%.malachite.ingestion.v2.ExporterStatsR\rexporterStats\x12.\n" +
