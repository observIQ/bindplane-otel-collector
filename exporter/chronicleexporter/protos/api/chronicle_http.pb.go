...
const file_chronicle_http_proto_rawDesc = "" +
	"\n" +
	"\x14chronicle_http.proto\x12\x16malachite.ingestion.v2\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd0\x03\n" +
	"\x03Log\x12\x12\n" +
	...
	"\x06labels\x18\x06 \x03(\v2'.malachite.ingestion.v2.Log.LabelsEntryR\x06labels\x1a_\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12:\n" +
	"\x05value\x18\x02 \x01(\v2$.malachite.ingestion.v2.Log.LogLabelR\x05value:\x028\x01\x1aC\n" +
	"\bLogLabel\x12\x14\n" +
	"\x05value\x18\x01 \x01(\tR\x05value\x12!\n" +
	"\frbac_enabled\x18\x02 \x01(\bR\vrbacEnabled\"\xb9\x02\n" +
	"\x11ImportLogsRequest\x12\x16\n" +
	"\x06parent\x18\x01 \x01(\tR\x06parent\x12a\n" +
	"\rinline_source\x18\x02 \x01(\v2:.malachite.ingestion.v2.ImportLogsRequest.LogsInlineSourceH\x00R\finlineSource\x12\x12\n" +
	"\x04hint\x18\x04 \x01(\tR\x04hint\x1a\x8a\x01\n" +
...
var (
	...
	file_chronicle_http_proto_rawDescData []byte
)

func file_chronicle_http_proto_rawDescGZIP() []byte {
	file_chronicle_http_proto_rawDescOnce.Do(func() {
		file_chronicle_http_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chronicle_http_proto_rawDesc), len(file_chronicle_http_proto_rawDesc)))
	})
...
var file_chronicle_http_proto_goTypes = []any{
	(*Log)(nil),               // 0: malachite.ingestion.v2.Log
	(*ImportLogsRequest)(nil), // 1: malachite.ingestion.v2.ImportLogsRequest
	nil,                       // 2: malachite.ingestion.v2.Log.LabelsEntry
	(*Log_LogLabel)(nil),      // 3: malachite.ingestion.v2.Log.LogLabel
	(*ImportLogsRequest_LogsInlineSource)(nil), // 4: malachite.ingestion.v2.ImportLogsRequest.LogsInlineSource
	(*timestamppb.Timestamp)(nil),              // 5: google.protobuf.Timestamp
}
var file_chronicle_http_proto_depIdxs = []int32{
	5, // 0: malachite.ingestion.v2.Log.log_entry_time:type_name -> google.protobuf.Timestamp
	5, // 1: malachite.ingestion.v2.Log.collection_time:type_name -> google.protobuf.Timestamp
	2, // 2: malachite.ingestion.v2.Log.labels:type_name -> malachite.ingestion.v2.Log.LabelsEntry
	4, // 3: malachite.ingestion.v2.ImportLogsRequest.inline_source:type_name -> malachite.ingestion.v2.ImportLogsRequest.LogsInlineSource
	3, // 4: malachite.ingestion.v2.Log.LabelsEntry.value:type_name -> malachite.ingestion.v2.Log.LogLabel
	0, // 5: malachite.ingestion.v2.ImportLogsRequest.LogsInlineSource.logs:type_name -> malachite.ingestion.v2.Log
...
func file_chronicle_http_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_chronicle_http_proto_rawDesc), len(file_chronicle_http_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
