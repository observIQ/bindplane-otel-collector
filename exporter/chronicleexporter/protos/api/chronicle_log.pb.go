...
const file_chronicle_log_proto_rawDesc = "" +
	"\n" +
	"\x13chronicle_log.proto\x12\x16malachite.ingestion.v2\x1a\fsource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf6\x01\n" +
	"\bLogEntry\x12\x12\n" +
	...
	"\x06source\x18\x04 \x01(\v2#.malachite.ingestion.v2.EventSourceR\x06source\"\x82\x02\n" +
	"\rLogEntryBatch\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\fR\x02id\x12;\n" +
	"\x06source\x18\x02 \x01(\v2#.malachite.ingestion.v2.EventSourceR\x06source\x12\x19\n" +
...
var (
	...
	file_chronicle_log_proto_rawDescData []byte
)

func file_chronicle_log_proto_rawDescGZIP() []byte {
	file_chronicle_log_proto_rawDescOnce.Do(func() {
		file_chronicle_log_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chronicle_log_proto_rawDesc), len(file_chronicle_log_proto_rawDesc)))
	})
	return file_chronicle_log_proto_rawDescData
}

var file_chronicle_log_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_chronicle_log_proto_goTypes = []any{
...
func file_chronicle_log_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_chronicle_log_proto_rawDesc), len(file_chronicle_log_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
