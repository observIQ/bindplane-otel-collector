...
const file_ingestion_proto_rawDesc = "" +
	"\n" +
	"\x0fingestion.proto\x12\x16malachite.ingestion.v2\x1a\x1cgoogle/api/annotations.proto\x1a\fevents.proto\x1a\x13chronicle_log.proto\"T\n" +
	"\x18BatchCreateEventsRequest\x128\n" +
	"\x05batch\x18\x01 \x01(\v2\".malachite.ingestion.v2.EventBatchR\x05batch\"\x1b\n" +
	"\x19BatchCreateEventsResponse\"U\n" +
	"\x16BatchCreateLogsRequest\x12;\n" +
	"\x05batch\x18\x01 \x01(\v2%.malachite.ingestion.v2.LogEntryBatchR\x05batch\"\x19\n" +
