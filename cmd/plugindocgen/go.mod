...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/storage/filestorage v0.138.0 // indirect
	...
	go.opentelemetry.io/collector/confmap/provider/httpsprovider v1.44.0 // indirect
	go.opentelemetry.io/collector/confmap/provider/yamlprovider v1.44.0 // indirect
	...
	go.opentelemetry.io/collector/otelcol v0.138.0 // indirect
