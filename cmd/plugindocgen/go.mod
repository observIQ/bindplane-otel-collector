...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/storage/filestorage v0.124.1 // indirect
	...
	go.opentelemetry.io/collector/confmap/provider/httpsprovider v1.30.0 // indirect
