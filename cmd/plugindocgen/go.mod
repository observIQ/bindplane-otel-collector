...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/storage/filestorage v0.120.0 // indirect
	...
	go.opentelemetry.io/collector/confmap/provider/httpsprovider v1.26.0 // indirect
