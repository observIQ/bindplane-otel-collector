...
> [!NOTE]
> Custom Bindplane components (receivers, processors, exporters, and extensions) have been migrated to [observiq/bindplane-otel-contrib](https://github.com/observiq/bindplane-otel-contrib). The modules in this repository are retained for reference and will be removed after September 2026.
